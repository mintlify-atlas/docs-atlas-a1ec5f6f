---
title: "Develop and Contribute to NestJS DevTools"
sidebarTitle: "Development"
description: "Set up the NestJS DevTools VS Code extension locally, run it in development mode, and submit contributions via pull request."
---
