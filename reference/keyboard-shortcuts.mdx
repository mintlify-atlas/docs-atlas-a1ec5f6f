---
title: "NestJS DevTools Keyboard Shortcuts Reference"
sidebarTitle: "Keyboard Shortcuts"
description: "All NestJS DevTools keyboard shortcuts for macOS and Windows/Linux — logger insertion chords and module navigation keybindings."
---
...
| Insert log | `Cmd+L` `Cmd+L` | `Ctrl+L` `Ctrl+L` | Editor focused |
